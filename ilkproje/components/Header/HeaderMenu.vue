...
<script>
import HeaderAltMenu from "./HeaderAltMenu.vue";
export default {
    components: { HeaderAltMenu },
    data() {
        return {
                ...
                },
                {
                    ...
                    subtitles: [
                        ...
                        },
                        {
                            ...
                            content: [
                                { id: 1, name: "Pantolon" },
                                { id: 2, name: "Denim Pantolon" },
                                { id: 3, name: "Casual Pantolon" },
                                { id: 4, name: "Etek" },
                                { id: 5, name: "Tayt" },
                                { id: 6, name: "Eşofman" },
                                { id: 7, name: "Şort" },
                        ...
                        },
                        {
                            ...
                            content: [
                                { id: 1, name: "Çanta" },
                                { id: 2, name: "Cüzdan" },
                                { id: 3, name: "El Çantası" },
                                { id: 4, name: "Atkı-Bere-Eldiven" },
                                { id: 5, name: "Kemer" },
                                { id: 6, name: "Takı" },
                                { id: 7, name: "Valiz" },
                                { id: 8, name: "Çorap" },
                    ...
                    name: "ERKEK", subtitles: [
                        {
                            ...
                            content: [
                                ...
                                { id: 4, name: "Sweatshirt" },
                                { id: 5, name: "Yelek" },
                                { id: 6, name: "Polo Yaka T-shirt" },
                                { id: 7, name: "T-Shirt" },
                                { id: 8, name: "Ceket" },
                                { id: 9, name: "Takım Elbise" },
                                { id: 10, name: "Smokin Takım Elbise" },
                            ],
                        },
                        {
                            id:6,
                        ...
                        },
                        {
                            ...
                            content: [
                                ...
                                { id: 2, name: "Kravat-Papyon" },
                                { id: 3, name: "Mendil" },
                                { id: 4, name: "Valiz" },
                                { id: 5, name: "Aksesuar" },
                                { id: 6, name: "Atkı-Bere-Eldiven" },
                                { id: 7, name: "Çorap" },
            ...
            subtitles: [],
            currentCategoryPhoto: undefined
        };
    },
    methods: {
        showSubMenu(category) {
            this.subtitles = category.subtitles;
