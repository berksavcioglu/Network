        ...
        <div class="custom-sticky d-flex justify-content-between bg-white">
            ...
            <div class="d-flex justify-content-start align-items-center">
                ...
                <img
                    ...
                    src="../static/images/threeitemactive.png"
                    width="30"
                    height="30"
                    alt
                />
                <img
                    ...
                    @click="threeItem()"
                    class="align-self-center pointer"
                    src="../static/images/threeitem.png"
                    width="30"
                    height="30"
                    alt
                />
                <img
                    ...
                    @click="fourItem()"
                    class="align-self-center pointer"
                    src="../static/images/fouritem.png"
                    width="30"
                    height="30"
                    alt
                />
                <img
                    ...
                    @click="fourItem()"
                    class="align-self-center pointer"
                    src="../static/images/fouritemactive.png"
                    width="30"
                    height="30"
                    alt
                />
...
.menu-custom::before {
    content: url(../static/images/az.png) !important;
    vertical-align: -25%;
...
.menu-custom2::before {
    content: url(../static/images/filter.png) !important;
    vertical-align: -30%;
    padding: 5px !important;
}
</style>